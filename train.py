...
from util import make_agent, FileWriter, safe_checkpoint
...
def create_parallel_env(args, make_fn):
    ...
    venv = VecPreprocessImageWrapper(venv=venv, obs_key='chars_crop',
...
if __name__ == '__main__':
    ...
    venv = create_parallel_env(args, lambda: gym.make(args.env_name))
    ...
    def checkpoint(index=None):
        ...
        safe_checkpoint({'runner_state_dict': train_runner.state_dict()}, 
                        checkpoint_path,
                        index=index, archive_interval=args.archive_interval)
